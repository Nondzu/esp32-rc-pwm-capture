...
#define RC_PWM1_PIN 2       // Ustaw pin do odbioru PWM
#define RC_PWM2_PIN 3          // Pin do generowania PWM (GPIO 3)
...
void app_main(void) {
    ...
    // xTaskCreate(pwm_generator_task, "pwm_generator_task", 4096, NULL, 5, NULL); // Nie dziala xD
    ...
    rmt_rx_channel_config_t rx_chan_config = {
        ...
        .gpio_num = RC_PWM1_PIN,            // GPIO do odczytu sygnału PWM
    ...
    rmt_receive_config_t receive_config = {
        ...
        .signal_range_max_ns = 3000000,   // Maksymalny czas trwania impulsu (2 ms dla PWM RC)
    };
